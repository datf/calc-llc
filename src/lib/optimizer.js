...
export const IGNORED_TYPES = ["mining_whistle", "ladder", "collector_whistle", "platform", "gravity_enhancer", "teleporter"];
export const INDEPENDENT_TYPES = ["poison_gun", "bomb", "flamethrower", "drill", "mortar_gun", "roundhouse_kick", "jet"];
export const MODIFIER_TYPES = ["water_gun", "water_staff"];
export const NON_STACKABLE_TYPES = ["roundhouse_kick", "poison_gun", "poison_staff", "flamethrower", "jet", "water_gun", "water_staff"];
...
export function calculateBestUpgrades(gameState, items, employees, upgradeStrategy) {
  ...
  topResults.push({...topResults[0], id: 2, projectedValue: dp[W] * 0.9, buy: {items:[], totalSpent:0}});
  topResults.push({...topResults[0], id: 3, projectedValue: dp[W] * 0.75, sell: {items:[], totalEarned:0}});
