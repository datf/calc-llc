...
<div class="page-wrapper page-wide">
  ...
  <p>Drag and drop your save anywhere on the screen, use the button in the header, or click below.</p>

  {#if !supportsFileSystemAPI}
    <div class="bg-amber-500/10 border-l-4 border-amber-500 p-4 mb-8 mt-8 rounded-r-md">
      <div class="flex items-start">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-amber-500 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div>
          ...
          <p class="text-sm mt-1 theme-text-muted">
            Your current browser doesn't support the File System Access API (often the case in Firefox or Safari).
            If you switch to a Chromium-based browser (like Chrome or Edge), you can enable <strong>Auto-Reload</strong> to automatically update this calculator in real-time as you play!
          </p>
        </div>
      </div>
    </div>
